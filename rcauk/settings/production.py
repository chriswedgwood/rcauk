...
DEBUG = False
ALLOWED_HOSTS = ['recoveringcouples.co.uk','www.recoveringcouples.co.uk',] 
...
DO_SPACES_SPACE_FOLDER = 'rcauk' # recommended: Your project name, e.g: 'blog' 
...
DO_SPACES_MEDIA_LOCATION = 'rcauk/media'
